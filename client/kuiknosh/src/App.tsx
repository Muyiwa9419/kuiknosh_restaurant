      ...
      <main className="flex-grow scroll-smooth">
          ...
          <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row items-center md:justify-between z-10">
            ...
            <div className="text-center md:text-left md:w-1/2">
              ...
              <p className="text-lg text-white max-w-xl mx-auto md:mx-0">
                Freshly prepared, mouthwatering dishes that bring people
                together. Experience the taste of home-cooked meals, made with
                love and care.
              </p>
              <a href="https://www.instagram.com/kuiknosh?igsh=YzljYTk1ODg3Zg==">
                <button
                  type="button"
                  className="bg-red-600 cursor-pointer text-white py-2 px-2 rounded-lg mt-6 transition-all duration-500 hover:scale-105 "
                >
                  Order Now
                </button>
              </a>
          ...
          <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row items-center md:justify-between z-10">
            ...
            <div className="text-center md:text-left md:w-1/2">
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-4 text-black">
                Passion for Great Food, <br />
                Served with Love
              </h2>
              <p className="text-lg text-black max-w-xl mx-auto md:mx-0">
                At Kuiknosh, we bring you the finest flavors inspired by The
                celebrity twin chef, crafted with high-quality ingredients,
                traditional recipes, and a passion for excellent service.
                Whether you're craving intercontinental cuisine, local
                delicacies, or seeking a cozy spot to enjoy with loved ones,
                we've got you covered. Welcome to a place where food meets
                passion!
              </p>
            </div>
          </div>
        ...
        <section id="gallery" className="bg-black py-16 px-4 ">
          <div className="max-w-5xl mx-auto text-center text-white ">
            ...
            <p>
              At Kuiknosh, we know that great food is all about variety. Whether
              you're a meat lover, a fan of crispy bites, or all about fresh
              veggies, we've got something something for you.
            </p>
            <a href="https://www.instagram.com/reel/DD1fqsyoKBU/?igsh=YzljYTk1ODg3Zg==">
              <button
                type="button"
                className="bg-red-600 cursor-pointer text-white py-2 px-2 rounded-lg mt-6 transition-all duration-500 hover:scale-105 "
              >
        ...
        >
          ...
          <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row items-center md:justify-between z-10">
            ...
            <div className="text-center md:text-left md:w-1/2">
              ...
              <p className="text-lg text-black max-w-xl mx-auto md:mx-0">
                BMT African Garden beside Switzerland Embassy: N0 155 Adetokunbo
                Ademola Wuse 2, Abuja, Nigeria
                <br />
                <strong>
                  <em>Phone(WhatsApp): +234 803 119 1589</em>
                </strong>
              </p>
